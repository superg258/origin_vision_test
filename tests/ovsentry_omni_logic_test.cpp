...
int main()
{
...

  {
    ...
    const auto decision = omniperception::evaluate_omni_retarget(
      continuation_candidate, make_accepted_target(accepted_candidate), current_abs_yaw_deg / 57.3,
      true, retarget_min_delta_deg);
...

  {
    ...
    const auto decision = omniperception::evaluate_omni_retarget(
      blocked_candidate, make_accepted_target(accepted_candidate), current_abs_yaw_deg / 57.3, true,
